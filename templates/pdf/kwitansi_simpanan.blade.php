		...
		<tr>
			<td>
				<table border="" style="border: 1px solid black; border-collapse:">
					...
					<tr>
						<td><b><?php echo 'Rp. '.number_format($model_simpanan['jumlah'],2,',','.'); ?></b></td>
						<?php if($model_simpanan['jenis']==1): ?>
							<td><b><?php echo 'Wajib'; ?></b></td>
						<?php elseif($model_simpanan['jenis']==2): ?>
					...
					<tr>
						<td></td>
						<td ><b>Jumlah Simpanan :</b> IDR <?php echo number_format($model_simpanan['jumlah'],2,',','.');; ?></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
