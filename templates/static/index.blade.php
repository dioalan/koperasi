...
<head>
   ...
   ================================================== -->
	...
	<!-- CSS
    ================================================== -->
   <link href="<?php echo Theme::base('../Woo10/css/default.css') ?>" rel="stylesheet" type="text/css" />
   <link href="<?php echo Theme::base('../Woo10/css/layout.css') ?>" rel="stylesheet" type="text/css" />
   <link href="<?php echo Theme::base('../Woo10/css/media-queries.css') ?>" rel="stylesheet" type="text/css" />
   <link href="<?php echo Theme::base('../Woo10/css/animate.css') ?>" rel="stylesheet" type="text/css" />
   <link href="<?php echo Theme::base('../Woo10/css/prettyPhoto.css') ?>" rel="stylesheet" type="text/css" />
   ...
   <script src="<?php echo Theme::base('../Woo10/js/modernizr.js') ?>" type="text/javascript"></script>


   <!-- Favicons
	================================================== -->
	<link rel="shortcut icon" href="<?php echo Theme::base('../Woo10/favicon.png') ?>">
...
<body>
   ...
   <div id="preloader">      
      <div id="status">
         <img src="../Woo10/images/preloader.gif" height="64" width="64" alt="">
      </div>
   </div>
   ...
   <header>
      ...
      <div class="logo">
         <a class="smoothscroll" href="#hero"><img alt="" src="../Woo10/images/logo.png"></a>
      </div>
      ...
      <nav id="nav-wrap">         
         ...
         <ul id="nav" class="nav">
            <li><a class="smoothscroll" href="#features">Product</a></li>
	         <li><a class="smoothscroll" href="#pricing">Price</a></li>
   ...
   <section id="hero">
	   ...
	   <div class="row">
		   ...
		   <div class="twelve columns">
			   ...
			   <div class="hero-text">
				   <h1 class="responsive-headline">The Premium Salad to showcase your awesome product and service.</h1>
            ...
            <div class="hero-image">
               <img src="../Woo10/images/ambrosia-recipe-fp.jpg" alt="" />
            </div>
   ...
   <section id='features'>
      ...
      <div class="row feature design">
         ...
         <div class="six columns feature-media left">
             <img src="../Woo10/images/BlueberryAmbrosia-3.jpg" alt="" />
         </div>
      ...
      <div class="row feature responsive">
         ...
         <div class="six columns feature-media right">
             <img src="../Woo10/images/Creamy_Fruit_Salad_1.jpg" alt="" />
         </div>
      ...
      <div class="row feature cross-browser">
         ...
         <div class="six columns feature-media left">
             <img src="../Woo10/images/fruit-salad-with-creamy-coconut-poppy-seed-dressing-8503620-April-01-2019-2.jpg" alt="" />
         </div>
            ...
            <div id="screenshots-wrapper" class="bgrid-quarters s-bgrid-thirds cf">
          	   ...
          	   <div class="columns item">
                  <div class="item-wrap">
                     ...
                     <a href="../Woo10/imagesscreenshots/big/creamy-fruit-salad-5.jpg" data-imagelightbox="a" >
                        <img src="../Woo10/images/screenshots/creamy-fruit-salad-5.jpg" alt="Line Icons">
               ...
               <div class="columns item">
                  <div class="item-wrap">
                     ...
                     <a href="images/screenshots/big/b-hipster.jpg" data-imagelightbox="a" >
                        <img src="../Woo10/images/screenshots/hipster.jpg" alt="Hipster">
                        <div class="overlay"></div>
                        <div class="link-icon"><i class="icon-plus"></i></div>
                     </a>
               ...
               <div class="columns item">
                  <div class="item-wrap">
                     ...
                     <a href="images/screenshots/big/b-authentic-vintage.jpg" data-imagelightbox="a" >
                        <img src="../Woo10/images/screenshots/authentic-vintage.jpg" alt="Authentic Vintage">                        
                        <div class="overlay"></div>
                        <div class="link-icon"><i class="icon-plus"></i></div>
                     </a>
               ...
               <div class="columns item">
                  <div class="item-wrap">
                     ...
                     <a href="images/screenshots/big/b-spot-uv-logo.jpg" data-imagelightbox="a" >
                        <img src="../Woo10/images/screenshots/spot-uv-logo.jpg" alt="Spot UV Logo">
                        <div class="overlay"></div>
                        <div class="link-icon"><i class="icon-plus"></i></div>
                     </a>
               ...
               <div class="columns item">
                  <div class="item-wrap">
                     ...
                     <a href="images/screenshots/big/b-tshirt-mockup.jpg" data-imagelightbox="a" >
                     	<img src="../Woo10/images/screenshots/tshirt-mockup.jpg" alt="TShirt Mockup">
                       	<div class="overlay"></div>
                        <div class="link-icon"><i class="icon-plus"></i></div>
                     </a>
               ...
               <div class="columns item">
                  <div class="item-wrap">
                     ...
                     <a href="images/screenshots/big/b-abstract-vector.jpg" data-imagelightbox="a" >
                        <img src="../Woo10/images/screenshots/abstract-vector.jpg" alt="Abstract Vector">
                        <div class="overlay"></div>
                        <div class="link-icon"><i class="icon-plus"></i></div>
                     </a>
               ...
               <div class="columns item">
                  <div class="item-wrap">
                     ...
                     <a href="images/screenshots/big/b-embossed-paper.jpg" data-imagelightbox="a" >
                        <img src="../Woo10/images/screenshots/embossed-paper.jpg" alt="Embossed Paper">                        
                        <div class="overlay"></div>
                        <div class="link-icon"><i class="icon-plus"></i></div>
                     </a>
               ...
               <div class="columns item">
                  <div class="item-wrap">
                     ...
                     <a href="images/screenshots/big/b-judah.jpg" data-imagelightbox="a" >
                        <img src="../Woo10/images/screenshots/judah.jpg" alt="Judah">
                        <div class="overlay"></div>
                        <div class="link-icon"><i class="icon-plus"></i></div>
                     </a>
      ...
      <div class="row">         
         ...
         <div class="six columns info">
            ...
            <div class="footer-logo">
               <a href="#">
                  <img src="../Woo10/images/footer-logo.png" alt="" />
               </a>
            </div>
   ...
   <script>window.jQuery || document.write('<script src="../Woo10/js/jquery-1.10.2.min.js"><\/script>')</script>
   <!-- <script type="text/javascript" src="js/jquery-migrate-1.2.1.min.js"></script> -->
   <script src="<?php echo Theme::base('../Woo10/js/jquery-migrate-1.2.1.min.js') ?>" type="text/javascript"></script>


   <script src="../Woo10/js/jquery.flexslider.js"></script>
   <script src="../Woo10/js/waypoints.js"></script>
   <script src="../Woo10/js/jquery.fittext.js"></script>
   <script src="../Woo10/js/jquery.fitvids.js"></script>
   <script src="../Woo10/js/imagelightbox.js"></script>
   <script src="../Woo10/js/jquery.prettyPhoto.js"></script>   
   <script src="../Woo10/js/main.js"></script>
